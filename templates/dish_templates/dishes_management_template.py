...
"""
This module contains a method that configures the dish menu, displaying
all possible options such as adding, deleting, and updating dishes.
"""


def dishes_management_template(dynamic_frame):
    # Method responsible for configuring all widgets within the dish menu.
    ...
    button_back = ttk.Button(dynamic_frame,
                             ...
                             command=lambda frame=dynamic_frame: utils.\
                                 template_handler.templ_handler('main_menu',
                                                                frame))
