...
def center_window(root):
    # Funcion para asegurar que el tamaño de la ventana
    ...
    root.geometry('{}x{}+{}+{}'.format(ancho_ventana,
                                       altura_ventana,
                                       x_pos, y_pos))
...
if __name__ == '__main__':
    ...
    style = ttk.Style()
    style.configure(frame_style, background=last_plain_bg)
    ...
    lbl_img = ttk.Label(static_frame, image=img,
